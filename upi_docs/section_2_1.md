...
If you load Cashfree's Web Checkout inside your own WebView rather than a system browser, you are responsible for intercepting the UPI deep link yourself, and the exact implementation differs by platform. See the tabs below.
