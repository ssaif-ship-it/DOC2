...
### Cashfree's Role as a Payment Aggregator

When you integrate UPI payments, Cashfree acts as your end-to-end facilitator within the National Payments Corporation of India (NPCI) ecosystem. Operating as a licensed Payment Aggregator (PA) under the Reserve Bank of India (RBI), Cashfree provides a secure and regulatory-compliant umbrella for your transactions. This allows you to focus on your core business while Cashfree handles the complex infrastructure.
...
A critical step in the onboarding process is the assignment of a Merchant Category Code (MCC). This standard 4-digit number classifies your business type within the financial ecosystem.

*   **Classification:** Defines your business activities and eligibility for specific high-value transaction limits.
*   **Rules of Engagement:** Dictates fundamental rules including transaction limits, pricing, and risk monitoring.
