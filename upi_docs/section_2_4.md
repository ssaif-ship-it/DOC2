...
<!-- Claude, confirmed correction for Saif: this table previously said Static QR is "Generated via Merchant Dashboard." Cashfree's own product announcement (cashfree.com/blog/whats-new-static-qr-code-on-softpos) states Static QR codes are generated from inside the softPOS app by delivery or field agents, not the dashboard. Corrected the Generation row below to match. -->
...
| **Generation** | Generated by your agents from inside the SoftPOS app. | Generated on-the-fly via SoftPOS App or Backend APIs. |
